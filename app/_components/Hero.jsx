      ...
      <div className="mx-auto max-w-screen-xl px-4 py-24 lg:flex lg:h-screen ">
        <div className="mx-auto max-w-xl text-center">
          <h1 className="text-3xl font-extrabold sm:text-5xl">
            ...
            <strong className="font-extrabold text-primary sm:block"> You can buy products from here. </strong>
          </h1>

          <p className="mt-4 sm:text-xl/relaxed">

            Digital e-commerce, often simply referred to as e-commerce, has revolutionized the way businesses operate and consumers shop.
          </p>
